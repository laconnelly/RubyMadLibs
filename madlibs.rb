...
gets.chomp
puts "Let's do this! It's simple. You fill in the parts of speech here, and I fill in the blanks and tell you a funny story. Here we go!"
...
puts "Once upon a time, there was a #{noun1} named #{name}. #{name} was just like every other #{noun1}: #{adj1}, #{adj2}, and #{adj3}. They liked to go #{verbing} and at night, would cook #{food} with their #{noun2}."
puts "Then one day, #{name} ran out of #{food} to cook. Feeling overcome with #{emotion1}, #{name} #{verbed1} into the streets of #{place}, yelling, demanding to know whatever happened to their precious #{food}."
